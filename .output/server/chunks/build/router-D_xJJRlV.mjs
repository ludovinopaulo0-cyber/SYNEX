import { k as compileDecodeCharMap, c as createLRUCache, t as trimPath, l as rewriteBasepath, m as composeRewrites, p as processRouteTree, n as processRouteMasks, o as resolvePath, q as cleanPath, s as trimPathRight, g as createControlledPromise, u as parseHref, v as executeRewriteInput, w as isDangerousProtocol, x as redirect, b as isRedirect, d as isNotFound, y as findSingleMatch, z as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, A as interpolatePath, B as nullReplaceEqualDeep, C as replaceEqualDeep, E as last, F as decodePath, G as findFlatMatch, f as functionalUpdate, H as findRouteMatch, i as isPromise, e as invariant, h as rootRouteId, I as executeRewriteOutput, J as encodePathLikeUrl, a as arraysEqual, S as React, T as jsxRuntimeExports, $ as createServerFn, M as useRouter, r as reactExports, N as dummyMatchContext, O as matchContext, U as isModuleNotFoundError, Z as TSS_SERVER_FUNCTION, j as isServer, K as trimPathLeft, L as joinPaths, Q as exactPathTest, R as removeTrailingSlash, _ as getServerFnById, P as requireReactDom, W as escapeHtml, X as getAssetCrossOrigin, V as useHydrated, Y as resolveManifestAssetLink } from "./server.mjs";
import { o as object, b as boolean, s as string, n as number } from "./schemas-CrY2pnAI.mjs";
...
const DESCRIPTION = "Gift Cards, Game Keys e produtos digitais para gamers em Angola. Entrega digital, pagamento em Kwanzas e atendimento pelo Instagram.";
...
function NotFound() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "grid min-h-screen place-items-center bg-ink px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-5xl font-bold text-violet/70", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 font-display text-lg font-semibold uppercase tracking-[0.18em] text-paper", children: "Página não encontrada" }),
...
const getProducts = createServerFn().handler(createSsrRpc("463fe7260f33516dba912f69f4041220c06689e845e42d00d0e5e51ea2f5f081"));
const createProduct = createServerFn({
  method: "POST"
}).inputValidator(authed.extend({
  product: productInput
})).handler(createSsrRpc("dd7550d45d4bdad24417c4fda0d2d12d759627736b77977871096d4aa3776ec3"));
const updateProduct = createServerFn({
  method: "POST"
}).inputValidator(authed.extend({
  id: number().int().positive(),
  product: productInput
})).handler(createSsrRpc("01b4e5d5d77d2ec12a054e02e73e55d95560d0ce9c3bff966e2775412406d93b"));
